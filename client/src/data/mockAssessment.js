export const sections = [
  { key: 'reading-writing', title: 'Reading & Writing', durationSeconds: 1920 },
  { key: 'math', title: 'Math', durationSeconds: 2100 },
]
...
export const questions = [
  ...
  },
  {
    id: 'math-3',
    sectionKey: 'math',
    prompt: 'If f(x) = 2x² - 5 and f(a) = 13, what is one possible value of a?',
    options: [
      { key: 'A', text: '2' },
      { key: 'B', text: '3' },
      { key: 'C', text: '4' },
    ...
    correctAnswer: 'B',
    explanation: '2a² - 5 = 13 → 2a² = 18 → a² = 9 → a = 3 or a = -3.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Rate = 180/3 = 60 mph. Distance = 60 × 5 = 300 miles.',
    skillTag: 'Rates',
  },
  {
    id: 'math-6',
    sectionKey: 'math',
    prompt: 'If 2^3 · 2^5 = 2^n, what is the value of n?',
    options: [
      { key: 'A', text: '8' },
      { key: 'B', text: '15' },
      { key: 'C', text: '32' },
